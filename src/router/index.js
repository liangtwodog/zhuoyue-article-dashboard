...
// 处理顺序
routers = Utils.sortByOrder(routers)
...
export const constantRoutes = [
  ...
  {
    path: '/404',
    component: () => import('@/views/dashboard/error-page/404'),
    hidden: true
  },
  {
    path: '/401',
    component: () => import('@/views/dashboard/error-page/401'),
    hidden: true
  },
  {
    path: '/',
...
export const asyncRoutes = [
  /** when your routing map is too long, you can split it into small routers **/
  ...routers,
